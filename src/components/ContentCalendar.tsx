  ...
  return (
    <>
                  ...
                  <div className="flex-1 space-y-1 overflow-y-auto">
                    {postsForDay.map((post) => (
                      <div
                        ...
                        className="bg-secondary/50 p-2 rounded-md text-xs cursor-pointer active:cursor-grabbing flex items-start gap-1"
                      >
      ...
      {editingPost && (
        <AddContentModal
          isOpen={!!editingPost}
          setIsOpen={(isOpen) => !isOpen && setEditingPost(null)}
